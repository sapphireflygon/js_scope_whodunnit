...
// Running this will crash out, as trying to reassign const variable murderer, therefore here the murderer is Professor Plum
```
...
// verdict: The weapon is the candle stick.
```
